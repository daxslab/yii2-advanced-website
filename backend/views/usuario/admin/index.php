...
$exportBtn = Html::a(Yii::t('app', '{icon} Export',
    [
        'icon' => Html::tag('i', null, ['class' => 'fas fa-file-excel'])
    ]),
    ['//user-admin/export-excel',],
    ['class' => 'btn btn-sm btn-primary', 'data-pjax' => 0])
?>

<?php $this->beginContent('@app/views/usuario/shared/admin_layout.php') ?>
...
<?= GridView::widget(
    [
        ...
        'layout' => ($dataProvider->count > 0) ?
            "<div class='mt-2 mb-2'>{summary}<div class='float-right'>{$exportBtn}</div></div>\n<div class='table-responsive'>{items}</div>\n{pager}" :
            "<div class='table-responsive'>{items}</div>\n{pager}",
        'summaryOptions' => ['class' => 'summary d-inline-block'],
        'columns' => [
            'username',
            'email:email',
            [
...
//                    'options' => ['class' => 'pp'],
//                    'value' => function ($model) {
//                        return $model->isConfirmed ? Yii::t('usuario', 'Confirmed') : Yii::t('usuario', 'Not Confirmed');
//                    },
//                    'visible' => false
//                ],
            [
...
//                'contentOptions' => ['class' => 'text-center skip-export'],
//                'headerOptions' => ['class' => 'skip-export'],
                'buttons' => [
...
//        'exportConversions' => [
//            [
//                'from' => Yii::t('usuario', 'Confirm'),
//                'to' => Yii::t('app', 'Not Confirmed')
//            ]
//        ]
    ]
); ?>
